<template>
  ...
  <div style="height: 300px; overflow: scroll; max-height: 300px;border: 1px solid #000;">
    <TyForm ref="form2" :formData="formData2" :rules="rules2">
      <TyButton @click="scroll"> 滚动</TyButton>
      <TyButton @click="submit2"> 提交</TyButton>
